...
const llinks = [  {    text: 'Acasă',    type: 'a',    href: '../Home/index.html',  },  {    text: 'Pentru grădina ta',    type: 'input',    id: 'allFor',  },  {    text: 'Despre',    type: 'a',    href: '../AboutUs/about.html',  },];
...
lang.addEventListener('click', () => {window.location.href = `../../${parentFolder}/${filename}`})
...
const droplinks = [
  {
    text: 'Încălțăminte și Îmbrăcăminte',
    href: '../Fc/clothing.html'
  },
  {
    text: 'Unelte de grădinărit',
    href: '../Gt/tools.html'
  },
  {
    text: 'Soluri și Îngrășăminte',
    href: '../Sf/soils.html'
  }
];
